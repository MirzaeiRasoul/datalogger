...
function register_routes()
{
    ...
    // register_rest_route($namespace, 'tractors/(?P<id>\d+)/sensors', ['methods' => 'POST', 'callback' => 'create_tractor_sensor_by_post_id']);
...
// /* POST: Callback for create a new sensor of a single tractor (It's make problem: validation for post_id)
// ****************************************************************************************************/
// function create_tractor_sensor_by_post_id($request)
// {
//     global $wpdb;
//     $request->get_param('id');
//     $table_name = $wpdb->prefix . 'sensors'; // wp_sensors
...
//     $sensor_persian_name = $request->get_param('sensor_persian_name');
//     $sensor_value = $request->get_param('sensor_value');
//     $now = current_time('mysql');

//     $response = array();
//     if (isset($post_id, $sensor_name, $sensor_persian_name, $sensor_value)) {
//         $query_result = $wpdb->insert(
//             $table_name,
//             array(
//                 'post_id'             => $post_id,
//                 'sensor_name'         => $sensor_name,
//                 'sensor_persian_name' => $sensor_persian_name,
...
//             'error' => array(
//                 'code' => 'missing_param',
//                 'detail' => 'This request need parameters: sensor_name, sensor_persian_name and sensor_value',
//                 'solution' => ''
//             )
//         );
//     }
